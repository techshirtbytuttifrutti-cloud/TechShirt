...
const ReferencesGallery: React.FC<ReferencesGalleryProps> = ({
  requestId,
  onSelectImage,
}) => {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
      {referencesWithUrls.map((ref, idx) => (
        <div
          key={ref._id}
          className="bg-white border border-gray-200 rounded-lg overflow-hidden cursor-pointer hover:shadow"
          onClick={() => ref.url && onSelectImage?.(ref.url)}
        >
